...
function scard.tg1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.SelectTarget(tp,aux.ManaZoneFilter(Card.DMIsAbleToGrave),tp,LOCATION_MZONE,0,1,1,nil)
	Duel.Hint(HINT_SELECTMSG,1-tp,HINTMSG_TOGRAVE)
	Duel.SelectTarget(1-tp,aux.ManaZoneFilter(Card.DMIsAbleToGrave),1-tp,LOCATION_MZONE,0,1,1,nil)
end
