...
function scard.tg1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g=Duel.SelectTarget(tp,scard.retfilter,tp,LOCATION_BZONE,LOCATION_BZONE,1,1,nil)
	...
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RTOHAND)
	Duel.SelectTarget(tp,scard.retfilter,tp,LOCATION_BZONE,LOCATION_BZONE,0,ct,g)
end
