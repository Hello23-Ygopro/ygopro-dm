...
OPTION_ANGEL_COMMAND	=aux.Stringid(10000003,4)	--Angel Command
OPTION_ARMORED_DRAGON	=aux.Stringid(10000002,5)	--Armored Dragon
OPTION_ARMORED_WYVERN	=aux.Stringid(10000002,11)	--Armored Wyvern
OPTION_ARMORLOID		=aux.Stringid(10000002,3)	--Armorloid
OPTION_BALLOON_MUSHROOM	=aux.Stringid(10000003,2)	--Balloon Mushroom
OPTION_BEAST_FOLK		=aux.Stringid(10000002,13)	--Beast Folk
OPTION_BERSERKER		=aux.Stringid(10000001,4)	--Berserker
OPTION_BRAIN_JACKER		=aux.Stringid(10000001,14)	--Brain Jacker
OPTION_CHIMERA			=aux.Stringid(10000002,0)	--Chimera
OPTION_COLONY_BEETLE	=aux.Stringid(10000002,15)	--Colony Beetle
OPTION_CYBER_CLUSTER	=aux.Stringid(10000001,8)	--Cyber Cluster
OPTION_CYBER_LORD		=aux.Stringid(10000001,7)	--Cyber Lord
OPTION_CYBER_MOON		=aux.Stringid(10000001,9)	--Cyber Moon
OPTION_CYBER_VIRUS		=aux.Stringid(10000001,6)	--Cyber Virus
OPTION_DARK_LORD		=aux.Stringid(10000002,2)	--Dark Lord
OPTION_DEATH_PUPPET		=aux.Stringid(10000003,15)	--Death Puppet
OPTION_DEMON_COMMAND	=aux.Stringid(10000003,5)	--Demon Command
OPTION_DEVIL_MASK		=aux.Stringid(10000003,14)	--Devil Mask
OPTION_DRAGO_NOID		=aux.Stringid(10000002,10)	--Dragonoid
OPTION_DUNE_GECKO		=aux.Stringid(10000004,0)	--Dune Gecko
OPTION_EARTH_DRAGON		=aux.Stringid(10000002,8)	--Earth Dragon
OPTION_EARTH_EATER		=aux.Stringid(10000003,13)	--Earth Eater
OPTION_FIRE_BIRD		=aux.Stringid(10000003,8)	--Fire Bird
OPTION_FISH				=aux.Stringid(10000001,10)	--Fish
OPTION_GEL_FISH			=aux.Stringid(10000001,11)	--Gel Fish
OPTION_GHOST			=aux.Stringid(10000001,13)	--Ghost
OPTION_GIANT			=aux.Stringid(10000003,0)	--Giant
OPTION_GIANT_INSECT		=aux.Stringid(10000003,1)	--Giant Insect
OPTION_GLADIATOR		=aux.Stringid(10000003,12)	--Gladiator
OPTION_GUARDIAN			=aux.Stringid(10000001,1)	--Guardian
OPTION_HEDRIAN			=aux.Stringid(10000003,7)	--Hedrian
OPTION_HORNED_BEAST		=aux.Stringid(10000003,3)	--Horned Beast
OPTION_HUMAN			=aux.Stringid(10000002,9)	--Human
OPTION_INITIATE			=aux.Stringid(10000001,3)	--Initiate
OPTION_LEVIATHAN		=aux.Stringid(10000001,12)	--Leviathan
OPTION_LIGHT_BRINGER	=aux.Stringid(10000001,0)	--Light Bringer
OPTION_LIQUID_PEOPLE	=aux.Stringid(10000001,5)	--Liquid People
OPTION_LIVING_DEAD		=aux.Stringid(10000001,15)	--Living Dead
OPTION_MACHINE_EATER	=aux.Stringid(10000002,4)	--Machine Eater
OPTION_MECHA_DEL_SOL	=aux.Stringid(10000004,4)	--Mecha Del Sol
OPTION_MECHA_THUNDER	=aux.Stringid(10000003,6)	--Mecha Thunder
OPTION_MELT_WARRIOR		=aux.Stringid(10000004,8)	--Melt Warrior
OPTION_MERFOLK			=aux.Stringid(10000004,6)	--Merfolk
OPTION_MYSTERY_TOTEM	=aux.Stringid(10000004,2)	--Mystery Totem
OPTION_NAGA				=aux.Stringid(10000004,13)	--Naga
OPTION_PANDORAS_BOX		=aux.Stringid(10000004,7)	--Pandora's Box
OPTION_PARASITE_WORM	=aux.Stringid(10000002,1)	--Parasite Worm
OPTION_PEGASUS			=aux.Stringid(10000004,14)	--Pegasus
OPTION_PHOENIX			=aux.Stringid(10000004,11)	--Phoenix
OPTION_RAINBOW_PHANTOM	=aux.Stringid(10000003,11)	--Rainbow Phantom
OPTION_ROCK_BEAST		=aux.Stringid(10000002,12)	--Rock Beast
OPTION_SEA_HACKER		=aux.Stringid(10000003,10)	--Sea Hacker
OPTION_SNOW_FAERIE		=aux.Stringid(10000004,3)	--Snow Faerie
OPTION_SOLTROOPER		=aux.Stringid(10000004,5)	--Soltrooper
OPTION_SPIRIT_QUARTZ	=aux.Stringid(10000004,10)	--Spirit Quartz
OPTION_STARLIGHT_TREE	=aux.Stringid(10000001,2)	--Starlight Tree
OPTION_STARNOID			=aux.Stringid(10000004,12)	--Starnoid
OPTION_SURVIVOR			=aux.Stringid(10000003,9)	--Survivor
OPTION_TREE_FOLK		=aux.Stringid(10000002,14)	--Tree Folk
OPTION_VOLCANO_DRAGON	=aux.Stringid(10000002,6)	--Volcano Dragon
OPTION_WILD_VEGGIES		=aux.Stringid(10000004,9)	--Wild Veggies
OPTION_XENOPARTS		=aux.Stringid(10000004,1)	--Xenoparts
OPTION_ZOMBIE_DRAGON	=aux.Stringid(10000002,7)	--Zombie Dragon
aux.race_desc_list={
