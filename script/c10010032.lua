...
function scard.initial_effect(c)
	...
	aux.EnableSilentSkill(c,0,aux.CheckCardFunction(Card.IsAbleToSZone,LOCATION_HAND,0),scard.op1,EFFECT_FLAG_CARD_TARGET)
end
--to shield zone, to hand
...
function scard.op1(e,tp,eg,ep,ev,re,r,rp)
	...
	--local g2=Duel.SelectMatchingCard(tp,aux.ShieldZoneFilter(scard.thfilter),tp,LOCATION_SZONE,0,1,1,nil,e)
	...
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local sg2=Duel.SelectMatchingCard(tp,aux.ShieldZoneFilter(scard.thfilter),tp,LOCATION_SZONE,0,1,1,nil,e)
