...
function scard.op1(e,tp,eg,ep,ev,re,r,rp)
	...
	local g1=Duel.SelectMatchingCard(tp,aux.ManaZoneFilter(scard.thfilter),tp,0,LOCATION_MZONE,0,ct1,nil,e)
	...
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RTOHAND)
	local g2=Duel.SelectMatchingCard(tp,scard.thfilter,tp,0,LOCATION_BZONE,0,ct2,nil,e)
