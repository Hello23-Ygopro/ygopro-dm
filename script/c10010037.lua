...
function scard.tg1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(scard.retfilter1,tp,LOCATION_BZONE,LOCATION_BZONE,1,nil)
		or Duel.IsExistingTarget(aux.ManaZoneFilter(Card.IsAbleToHand),tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) end
	local g1=Duel.GetMatchingGroup(scard.retfilter2,tp,LOCATION_BZONE,LOCATION_BZONE,nil,e)
	local g2=Duel.GetMatchingGroup(aux.ManaZoneFilter(scard.retfilter3),tp,LOCATION_MZONE,LOCATION_MZONE,nil,e)
	g1:Merge(g2)
